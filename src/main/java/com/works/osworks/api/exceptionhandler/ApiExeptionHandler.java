package com.works.osworks.api.exceptionhandler;
...
public class ApiExeptionHandler extends ResponseEntityExceptionHandler{
	...
	public ResponseEntity<Object>  handleEntidadeNaoEncontratada(NegocioExcepetion ex, WebRequest request) {
	...
	public ResponseEntity<Object>  handleNegocio(NegocioExcepetion ex, WebRequest request) {
		var status = HttpStatus.BAD_REQUEST;
